...
def find_diffs():
    try:
        if not os.path.isfile('compare.xml'):
            print("No previous results to comapre too (compare.xml does not exist).")
            return
...
if __name__ == "__main__":
    ...
    while ui not in quits:
        ...
        print("Starting scan, this may take a while, sit tight.")
        scan(range, options)
